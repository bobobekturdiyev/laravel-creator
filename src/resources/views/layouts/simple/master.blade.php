...
<head>
    ...
    <link rel="icon" href="{{asset('assets/images/logo/photo.png')}}" type="image/x-icon">
    <link rel="shortcut icon" href="{{asset('assets/images/logo/photo.png')}}" type="image/x-icon">
